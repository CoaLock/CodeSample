//
//  ArticleVerifiedViewController.m
//  YS_iOS
//
...
@interface ArticleVerifiedViewController () <UITableViewDelegate, UITableViewDataSource, RefreshTableViewDelegate>
...
@implementation ArticleVerifiedViewController
...
- (BlankDisplayView*)createBlankView {
    if (self.blankView == nil) {
        ...
        self.blankView = [[BlankDisplayView alloc] initWithFrame:_tableView.frame img:@"ic_audited" title:@"您没有待审核文章哦" bgColor:kBackgroundColor];
...
- (void)getUserArticleList {
    ...
    [articleListApi getArticleListWithIsAudit:1 firstRow:_firstRow fetchNum:kPageFetchNum  callback:^(id resultData, NSInteger code) {
