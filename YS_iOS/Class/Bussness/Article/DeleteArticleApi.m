...
@implementation DeleteArticleApi {
...
- (void)deleteArticleWithArticleId:(NSInteger)articleId callback:(ApiRequestCallBack)callback {
    ...
    [tool asynPostWithBaseUrl:nil apiMethod:@"xiaocao.userArticle.deleteArticle"
...
- (NSDictionary *)publicParameters {
    ...
    params[@"api_name"] = @"xiaocao.userArticle.deleteArticle";
