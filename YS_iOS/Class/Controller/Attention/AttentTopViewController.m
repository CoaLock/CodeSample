...
@interface AttentTopViewController () <UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, RefreshCollectionViewDelegate>
...
@implementation AttentTopViewController
...
- (BlankDisplayView*)createBlankView {
    if (self.blankView == nil) {
        ...
        BlankDisplayView *blankView = [[BlankDisplayView alloc] initWithFrame:CGRectMake(0, 45, kScreenWidth, kScreenHeight - 64 -45) img:@"ic_attent_lable" title:@"该标签下还没有任何文章哦" bgColor:kBackgroundColor];
...
- (void)getTagArticleList {
    ...
    GetTagArticleListApi *articleListApi = [[GetTagArticleListApi alloc] init];
    [articleListApi getTagArticleListWithTagId:_tagId firstRow:_firstRow fetchNum:kPageFetchNum callback:^(id resultData, NSInteger code) {
