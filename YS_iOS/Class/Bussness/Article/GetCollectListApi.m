...
@implementation GetCollectListApi  {
...
- (void)getCollectListWithFirstRow:(NSInteger)firstRow fetchNum:(NSInteger)fetchNum callback:(ApiRequestCallBack)callback {
    ...
    [tool asynPostWithBaseUrl:nil apiMethod:@"xiaocao.socialArticle.getCollectList"
...
- (NSDictionary *)publicParameters {
    ...
    params[@"api_name"] = @"xiaocao.socialArticle.getCollectList";
