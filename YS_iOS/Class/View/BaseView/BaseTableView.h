...
/* 选中cell上的button时可使用 */
- (void)refreshTableViewButtonClick:(BaseTableView *)refreshTableview WithButton:(id)sender SelectRowAtIndex:(NSInteger)index;
...
@property (nonatomic, assign) BOOL isClosedPullUpCallback;
