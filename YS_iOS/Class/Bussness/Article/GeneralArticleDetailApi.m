...
@implementation GeneralArticleDetailApi {
...
- (void)getArticleDetailWithArticleId:(NSInteger)articleId callback:(ApiRequestCallBack)callback {
    ...
    [tool asynPostWithBaseUrl:nil apiMethod:@"xiaocao.generalArticle.getArticleDetail"
...
- (NSDictionary *)publicParameters {
    ...
    params[@"api_name"] = @"xiaocao.generalArticle.getArticleDetail";
